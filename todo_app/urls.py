...
urlpatterns = [
    ...
    path('list/<int:pk>/delete/', views.ToDoListDelete.as_view(), name='list-delete'),
    ...
    path('list/<int:list_id>/item/<int:pk>/delete/', views.ToDoItemDelete.as_view(), name='item-delete'),
]
